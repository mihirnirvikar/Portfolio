    ...
    <>
      <nav className="navbar flex items-center mx-7 font-medium mt-2">
        <ul className="flex gap-4">
          <li className="h-10 border-b-2 border-orange-500">
          ...
          <li>
            <div className="flex items-center gap-1 cursor-pointer hover:bg-gray-300 rounded-md w-30 h-8 justify-center ">
              <svg
                stroke="currentColor"
                fill="none"
                stroke-width="7"
