  ...
  return (
    <>
      <div className="ml-2 mb-10">
        ...
        <div className="flex flex-wrap gap-2 w-full mt-6 px-2 ">
          <div className="w-20 h-25 border px-2 py-1 rounded-lg">
            <a
          ...
          <div className="w-20 h-25 border px-2 py-3 rounded-lg">
            <a
              className="flex flex-col items-center "
          ...
          <div className="w-20 h-25 border px-2 py-3 rounded-lg">
            ...
            >
              <img
                ...
                alt="Linkedin Image"
              />
              <p className="text-sm mt-3 font-semibold text-blue-700">
                LinkedIn
              </p>
            </a>
          </div>
