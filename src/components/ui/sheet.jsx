...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out ",
  {
    variants: {
      side: {
        top: "top-0 inset-x-0 md:left-1/2 md:-translate-x-1/2 m-2 h-[50vh] md:h-[60vh] border data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top min-w-0 max-w-3xl md:w-3xl rounded-lg dark:bg-[#0D1117] bg-[#FFFFFF] backdrop-blur-sm",
        bottom:
          "inset-x-0 bottom-0 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
        left: "inset-y-0 left-0 h-full w-3/4 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm",
        right:
          "inset-y-0 right-0 h-full w-68 md:w-80 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right dark:bg-[#0D1117] bg-[#FFFFFF]",
      },
    },
    defaultVariants: {
      side: "right",
